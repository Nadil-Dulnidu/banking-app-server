package com.bankingapp.root.util;
...
public class JwtUtil {
    ...
    public String generateToken(String username, Constants.UserRoles role) {
    ...
    public Constants.UserRoles extractRole(String token) {
        return extractAllClaims(token).get("role", Constants.UserRoles.class);
    }
